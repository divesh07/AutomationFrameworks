...
public class Util {
    ...
    public static Response sendGetRequestWithParams(String url, String jwt, Map<String, String> queryParam) throws IOException, KeyManagementException,
            NoSuchAlgorithmException {
        url = url + "?filter=";
        WebTarget target = JERSEYCLIENT.target(url);
    ...
    public static Response sendPostRequestWithParams(String url, MultivaluedMap<String, String> input, Map<String, String> queryParam) throws IOException, KeyManagementException,
            NoSuchAlgorithmException {
        url = url + "?";
        WebTarget target = JERSEYCLIENT.target(url);
        for (Map.Entry<String, String> entry : queryParam.entrySet()) {
        ...
        //Response postResponse = target.request(MediaType.APPLICATION_JSON).post(Entity.json(input));
        Response postResponse = target.request(MediaType.TEXT_PLAIN, MediaType.APPLICATION_JSON).post(Entity.form(input));
        LOG.info("GET request response = {}", postResponse);
        return postResponse;
    }

    public static Response sendPostRequestWithParams(String url, String input, Map<String, String> queryParam) throws IOException, KeyManagementException,
            NoSuchAlgorithmException {
        url = url + "?";
        WebTarget target = JERSEYCLIENT.target(url);
        for (Map.Entry<String, String> entry : queryParam.entrySet()) {
    ...
    public static Response sendPostRequestWithParamsAndToken(String url, MultivaluedMap<String, String> input,
